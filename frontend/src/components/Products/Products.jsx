                    ...
                    <div className="hidden sm:flex flex-col w-1/5 px-1">
                        ...
                        <div className="flex flex-col bg-white rounded-sm shadow">
                            ...
                            <div className="flex items-center justify-between gap-5 px-4 py-2 border-b">
                                ...
                                <span className="uppercase text-primary-blue text-xs cursor-pointer font-medium" onClick={() => clearFilters()}>Xóa tất cả</span>
                            </div>
                            ...
                            <div className="flex flex-col gap-2 py-3 text-sm overflow-hidden">
                                ...
                                <div className="flex flex-col gap-2 border-b px-4">
                                    ...
                                    <div className="flex gap-3 items-center justify-between mb-2 min-w-full">
                                        <span className="flex-1 border px-4 py-1 rounded-sm text-gray-800 bg-gray-50">đ{price[0].toLocaleString()}</span>
                                        <span className="font-medium text-gray-400">đến</span>
                                        <span className="flex-1 border px-4 py-1 rounded-sm text-gray-800 bg-gray-50">đ{price[1].toLocaleString()}</span>
                                    </div>
                                </div>
                                {/* price slider filter */}
                                    ...
                                    {ratingsToggle && (
                                        <div className="flex flex-col pb-1">
                                            <FormControl>
                                                ...
                                                >
                                                    {[4, 3, 2, 1].map((el, i) => (
                                                        <FormControlLabel value={el} key={i} control={<Radio size="small" />} label={<span className="flex items-center text-sm">{el}<StarIcon sx={{ fontSize: "12px", mr: 0.5 }} /> trở lên</span>} />
                                                    ))}
                                                </RadioGroup>
                                            </FormControl>
                                        </div>
                    ...
                    <div className="flex-1">
                        ...
                        {!loading && products?.length === 0 && (
                            <div className="flex flex-col items-center justify-center gap-3 bg-white shadow-sm rounded-sm p-6 sm:p-16">
                                ...
                                <p className="text-xl text-center text-primary-grey"></p>
                            </div>
                        )}
