...
const Footer = () => {
  ...
  return (
    <>
      {!adminRoute && (
        <>
          <footer className="mt-20 w-full py-1 sm:py-4 px-4 sm:px-12 bg-black text-white text-xs border-b border-gray-600 flex flex-col sm:flex-row overflow-hidden">
            ...
            <div className="w-full sm:w-5/12 my-6 mx-5 sm:mx-0 flex flex-col sm:flex-row gap-2 sm:gap-0 justify-between">
              <div className="w-full sm:w-1/2">
                ...
                <p className="mt-2 leading-5">
                  Gọi mua:
                  <a className="text-primary-blue" href="tel:1900 232 461">
                    1900 232 46 (8:00 - 21:30){" "}
                  </a>
                  <br />
                  Khiếu nại:{" "}
                  <a className="text-primary-blue" href="tel:18002029898">
                    1800.1063 (8:00 - 21:30)
                  </a>
                  <br />
                  Bảo hành:{" "}
                  <a className="text-primary-blue" href="tel:18002029898">
              ...
              <div className="w-full sm:w-1/2">
                <h2 className="text-primary-grey">
                  © 2014. Công ty cổ phần Trang Sức:{" "}
                </h2>
                <p className="mt-2 leading-5">
                  GPDKKD: 0303217354 do sở KH & ĐT TP.HCM cấp ngày 02/01/2007.
                  GPMXH: 21/GP-BTTTT do Bộ Thông Tin và Truyền Thông cấp ngày
                  11/01/2021. Địa chỉ: 128 Trần Quang Khải, P.Tân Định, Q.1,
                  TP.Hồ Chí Minh. Telephone:{" "}
                  <a className="text-primary-blue" href="tel:18002029898">
                    1800 202 9898
                  </a>
                </p>
          ...
          <div className="px-16 py-6 w-full bg-[#fce5e5] hidden sm:flex justify-between items-center text-sm text-black">
            <a
