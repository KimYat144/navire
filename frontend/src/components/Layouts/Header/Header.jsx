...
const Header = () => {
  ...
  return (
    <header className="bg-[#fce5e5] fixed top-0 py-2.5 w-full z-10">
      {/* <!-- navbar container --> */}
      <div className="w-full sm:w-9/12 px-1 sm:px-4 m-auto flex justify-between items-center relative">
        ...
        <div className="flex items-center flex-1">
          <Link className="h-7 mr-1 sm:mr-4" to="/">
            <img
              draggable="false"
              className="h-[40px] items-center m-0 object-contain"
              src={logo}
              alt="Flipkart Logo"
            />
          </Link>
        ...
        <div className="flex items-center justify-between ml-1 sm:ml-0 gap-0.5 sm:gap-7 relative">
          ...
          <Link
            to="/cart"
            className="flex items-center text-black font-medium gap-2 relative"
          >
            <span>
              <ShoppingCartIcon />
            </span>
