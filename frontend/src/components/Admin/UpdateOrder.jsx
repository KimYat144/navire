          ...
          {order && order.user && order.shippingInfo && (
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row bg-white shadow-lg rounded-lg min-w-full">
                ...
                >
                  <h3 className="font-medium text-lg">Cập nhật tình trạng</h3>
                  <div className="flex gap-2">
                    <p className="text-sm font-medium">Tình trạng hiện tại:</p>
                    <p className="text-sm">
                  ...
                  <FormControl fullWidth sx={{ marginTop: 1 }}>
                    ...
                    >
                      ...
                      {order.orderStatus === "Processing" && (
                        <MenuItem value={"Shipped"}>Đang xử lý</MenuItem>
                      )}
                      {order.orderStatus === "Delivered" && (
                      ...
                      <div className="flex flex-col sm:flex-row sm:w-1/2 gap-1">
                        ...
                        <div className="flex flex-col gap-1 overflow-hidden">
                          ...
                          <p className="text-xs text-gray-600">
                            Giá: đ{price.toLocaleString()}
                          </p>
                          <span className="font-medium">
                            Tổng cộng: đ{(quantity * price).toLocaleString()}
                          </span>
                        </div>
                      </div>
