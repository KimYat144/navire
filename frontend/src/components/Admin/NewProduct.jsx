...
const NewProduct = () => {
  ...
  const newProductSubmitHandler = (e) => {
    ...
    if (specs.length <= 1) {
      enqueueSnackbar("Thêm tối thiểu 2 thông số kỹ thuật ", {
        variant: "warning",
      });
      return;
    }
  ...
  return (
    <>
      ...
      <form
        ...
        className="bg-white rounded-lg shadow p-4 max-w-screen-xl mx-auto mt-6 flex flex-col lg:flex-row gap-4"
        id="mainform"
      >
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-center border rounded">
              ...
              <span
                ...
                className="py-2 px-6 bg-[#64afe9] text-white rounded-r hover:shadow-lg cursor-pointer"
              >
                Thêm
              </span>
            </div>
          ...
          <h2 className="font-medium">Chi tiết thương hiệu</h2>
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="flex justify-evenly gap-2 items-center">
            ...
            <span
              onClick={() => addSpecs()}
              className="py-2 px-6 bg-[#64afe9] text-white rounded hover:shadow-lg cursor-pointer"
            >
              Thêm
            </span>
          </div>
          ...
          <h2 className="font-medium">Hình ảnh sản phẩm</h2>
          ...
          <div className="flex justify-end">
            <input
              form="mainform"
              type="submit"
              className="bg-[#64afe9] uppercase w-1/3 p-3 text-white font-medium rounded shadow hover:shadow-lg cursor-pointer"
              value="Xác nhận"
            />
          </div>
        </div>
