                  ...
                  <div className="w-full flex gap-3">
                    ...
                    {product.stock > 0 && (
                      <button
                        ...
                        className="p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-black rounded-sm shadow hover:shadow-lg"
                      >
                        <ShoppingCartIcon />
                    ...
                    <button
                      ...
                      className={
                        product.stock < 1
                          ...
                          : "p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-[gray] rounded-sm shadow hover:shadow-lg"
                      }
                    >
                      <FlashOnIcon />
                ...
                <div className="flex flex-col gap-2 mb-4">
                  ...
                  <div className="flex items-baseline gap-2 text-3xl font-medium">
                    ...
                    <span className="text-base text-gray-500 line-through">
                      {product.cuttedPrice?.toLocaleString()}đ
                    </span>
                    <span className="text-base text-primary-green"></span>
                  </div>
                  {product.stock <= 10 && product.stock > 0 && (
                    <span className="text-red-500 text-sm font-medium">
                      Số lượng còn {product.stock} sản phẩm
                    </span>
                  )}
                  {/* <!-- price desc --> */}
                  ...
                  {Array(3)
                    ...
                    .map((el, i) => (
                      <p className="text-sm flex items-center gap-1" key={i}>
                        ...
                        Giảm giá ngay lập tức 15% cho đơn hàng đầu tiên từ 500
                        trở lên{" "}
                        <Link
                  ...
                  <div className="flex gap-8 mt-2 items-center text-sm">
                    <img
                      ...
                      src={product.brand?.logo?.url || "https://via.placeholder.com/80x32?text=Logo"}
                      alt={product.brand && product.brand.name}
                    />
                    <span>
                      {" "}
                      Bảo hành {product.warranty} năm{" "}
                  ...
                  <div className="w-full mt-4 rounded-sm border flex flex-col">
                    <div className="flex justify-between items-center border-b px-6 py-4">
                      ...
                      <button
                        ...
                        className="shadow bg-black text-white px-4 py-2 rounded-sm hover:shadow-lg"
                      >
                        {" "}
                        Đánh giá sản phẩm
                      </button>
                    ...
                    >
                      ...
                      <DialogActions>
                        <button
                          onClick={handleDialogClose}
                          className="py-2 px-6 rounded shadow bg-gray-600 hover:bg-gray-700 text-white uppercase"
                        >
                          Hủy
                        </button>
                        <button
                          onClick={reviewSubmitHandler}
                          className="py-2 px-6 rounded bg-gray-600 hover:bg-gray-700 text-white shadow uppercase"
                        >
                          Xác nhận
                        </button>
                      </DialogActions>
