...
const EmptyCart = () => {
    return (
        <div className="flex items-center flex-col gap-2 m-6">
            ...
            <p className="text-xs">Hãy thêm các sản phẩm vào đây.</p>
            <Link to="/products" className="bg-primary-blue text-sm text-white px-12 py-2 rounded-sm shadow mt-3">Mua Ngay</Link>
        </div>
    );
};
